...
void start_websocket_server() {
  ...
  //setup handlers
  ws_server.set_open_handler(bind(&routing_server::on_open, &route_srv, std::placeholders::_1));
  ws_server.set_close_handler(bind(&routing_server::on_close, &route_srv, std::placeholders::_1));
  ws_server.set_message_handler(bind(&routing_server::on_message, &route_srv, std::placeholders::_1, std::placeholders::_2));
